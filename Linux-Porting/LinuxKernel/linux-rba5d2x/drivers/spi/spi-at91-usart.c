...
{
	struct spi_master *controller = dev_id;
...
{
	struct at91_usart_spi *aus = spi_master_get_devdata(spi->master);
...
int at91_usart_spi_transfer_one(struct spi_master *ctlr,
...
int at91_usart_spi_prepare_message(struct spi_master *ctlr,
...
int at91_usart_spi_unprepare_message(struct spi_master *ctlr,
				     struct spi_message *message)
{
	struct at91_usart_spi *aus = spi_master_get_devdata(ctlr);
